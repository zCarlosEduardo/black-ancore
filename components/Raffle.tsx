...
export default function RaffleSection() {
  return (
    <>
      <div
        className="relative bg-contain bg-right bg-no-repeat bg-raffle-section"
        style={{
          backgroundImage: "url('/BackgroundBall.svg')",
          backgroundSize: "100%",
        }}
      >
        ...
        <section
          id="sorteios"
          className="flex flex-col lg:flex-row items-center justify-center text-center gap-8 lg:gap-20 px-4 py-12 lg:py-16"
        >
          {/* Imagem ilustrativa */}
          <Image
            src="/IconSorteio.svg"
          ...
          <div className="text-center lg:text-start flex flex-col gap-4 lg:gap-6 max-w-2xl lg:max-w-none lg:-translate-x-[168px] lg:-translate-y-12">
            <h2 className="font-bold text-center lg:text-start mb-6 lg:mb-12 text-3xl md:text-4xl lg:text-5xl xl:text-6xl max-w-xl md:max-w-2xl lg:w-[496px]">
              E tem mais: Concorra a sorteios de{" "}
              <span className="text-red-600">5 PIX de R$1.000,00!</span>
            </h2>
            <p className="text-xl md:text-2xl lg:text-2xl xl:text-3xl font-light max-w-xl md:max-w-2xl lg:w-[568px]">
