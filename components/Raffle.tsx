...
export default function RaffleSection() {
  return (
    <div className="relative">
      {/* Background otimizado - Desktop */}
      <div className="absolute right-0 top-0 bottom-0 pointer-events-none hidden lg:block lg:w-[calc(100%-240px)]">
        <Image
      ...
      {/* Background otimizado - Mobile */}
      <div className="absolute right-0 top-0 bottom-0 w-full pointer-events-none lg:hidden">
        <Image
          src="/BackgroundBall.svg"
          alt=""
          fill
      ...
      >
        ...
        <div className="text-center lg:text-start flex flex-col gap-4 lg:gap-6 max-w-2xl lg:max-w-none lg:-translate-x-[168px] lg:-translate-y-12">
          <h2 className="font-bold text-center lg:text-start mb-6 lg:mb-12 text-3xl md:text-4xl lg:text-5xl xl:text-6xl max-w-xl md:max-w-2xl lg:max-w-[496px]">
