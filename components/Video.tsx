...
export default function VideoSection() {
  return (
    <section className="flex flex-col gap-8 md:gap-12 justify-center items-center pt-16 md:pt-32 lg:pt-40 pb-16 md:pb-24 lg:pb-32 relative px-4 md:min-h-screen overflow-hidden">
      ...
      <div className="hidden md:block absolute top-1/3 left-0 -translate-x-1/4 -translate-y-1/5 bg-red-600 opacity-10 blur-3xl w-[900px] h-[700px] rounded-full pointer-events-none" />
      <div className="md:hidden absolute top-1/4 right-0 translate-x-1/4 bg-red-600 opacity-20 blur-3xl w-80 h-80 rounded-full pointer-events-none" />
      <div className="md:hidden absolute bottom-5 -left-12 -translate-x-1/4 bg-red-600 opacity-20 blur-3xl w-96 h-96 rounded-full pointer-events-none" />
      
      {/* Título da seção - SEM z-10 */}
